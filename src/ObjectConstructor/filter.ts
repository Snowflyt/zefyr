 ...
 * filter(obj, ([key, value]) => key === 'a' || value === 42); // => { 5: 42, a: 1 }
 * const filtered = filter(obj, ([key, value]) => key === 'a' || value === 42); // filtered :: { 5?: number | undefined, a?: number | undefined, b?: number | undefined }
 * ```
 */
